...
# класс демона был взят из https://github.com/serverdensity/python-daemon
class Daemon(object):
    """
...
if __name__ == "__main__":
    logfile = str(pathlib.Path.cwd() / 'log')
    server_daemon = Daemon(str(pathlib.Path.cwd() / 'daemon.pid'), stderr=logfile, stdout=logfile)
